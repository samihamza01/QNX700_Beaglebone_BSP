...
#ifndef SWITCHMODE
    bsd_mii_finimedia(ti814x);
    ti814x_finiphy(ti814x);
#endif
...

{
    ...
    ti814x->cfg.mtu = ETHERMTU;
    ti814x->cfg.mru = ETHERMTU;
    ti814x->cfg.flags |= NIC_FLAG_MULTICAST;
    ti814x->cfg.mac_length = ETHER_ADDR_LEN;
    ...
    if (ti814x->cfg.mtu == 0 || ti814x->cfg.mtu > (ETHER_MAX_LEN - ETHER_CRC_LEN)) {
		ti814x->cfg.mtu = (ETHER_MAX_LEN - ETHER_CRC_LEN);
    }

    if (ti814x->cfg.mru == 0 || ti814x->cfg.mru > (ETHER_MAX_LEN - ETHER_CRC_LEN)) {
		ti814x->cfg.mru = (ETHER_MAX_LEN - ETHER_CRC_LEN);
    }
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devnp/dm814x/ti814x.c $ $Rev: 819741 $")
#endif
