/*
 * $QNXLicenseC:
 * Copyright 2009,2013,2017 QNX Software Systems.
 *
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/spi/dm816x/omap3spi.c $ $Rev: 822852 $")
#endif
